...
## This is for anyone that needs to find a restroom. ##
...
## Problem ##
  > Not being able to find a restroom to use in an urban environment.

## Solution ##
  > This app will show you the nearest restroom with information such as the hours and pin if it has one.
